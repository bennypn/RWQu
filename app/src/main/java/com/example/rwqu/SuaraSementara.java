...
public class SuaraSementara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suara_sementara);
        recyclerView = findViewById(R.id.recyclerView3);
        Button btnBack = findViewById(R.id.btn_kembalisuarasementara);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent;
                intent = new Intent(SuaraSementara.this,
                        WargaActivity.class);
